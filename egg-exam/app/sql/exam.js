 ...
 * @Last Modified time: 2019-03-13 11:13:14
 */
...
// 随机获取某一学科的五道题
exports.getRandomQuestions = (subject_id, number)=>{
    return SQL_ALLQUESTIONS + `AND questions.subject_id='${subject_id}' ORDER BY RAND() LIMIT ${number}`;
}
