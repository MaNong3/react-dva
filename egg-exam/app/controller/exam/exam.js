 ...
 * @Last Modified time: 2019-03-12 22:06:45
 */
...
class ExamController extends Controller{
    ...
    async create(){
        ...
        let {subject_id, number} = this.ctx.request.body;
        // 获取所有符合条件的试题
        // let {questions, subject_ids} = await this.service.exam.exam.beforeSubjectsQuestions(subject_id, exam_id);
        // questions = this.ctx.helper.randomExam(questions, subject_ids);
        // console.log('questions..', questions);

        console.log('subject_id...', subject_id, number, this.ctx.request.body);
        // 通过sql随机抽题
        let questions = await this.service.exam.exam.getSubjectQuestions(subject_id, number);
        // 插入数据库中
